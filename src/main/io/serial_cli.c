...
const clivalue_t valueTable[] = {
    ...
    { "gyro_notch3_hz",             VAR_UINT16 | MASTER_VALUE,  &masterConfig.gyro_soft_notch_hz_3, .config.minmax = { 0,  1000 } },
    { "gyro_notch3_cutoff",         VAR_UINT16 | MASTER_VALUE,  &masterConfig.gyro_soft_notch_cutoff_3, .config.minmax = { 1,  1000 } },
    { "gyro_notch4_hz",             VAR_UINT16 | MASTER_VALUE,  &masterConfig.gyro_soft_notch_hz_4, .config.minmax = { 0,  1000 } },
    { "gyro_notch4_cutoff",         VAR_UINT16 | MASTER_VALUE,  &masterConfig.gyro_soft_notch_cutoff_4, .config.minmax = { 1, 1000 } },
    { "gyro_notch5_hz",             VAR_UINT16 | MASTER_VALUE,  &masterConfig.gyro_soft_notch_hz_5, .config.minmax = { 0,  1000 } },
    { "gyro_notch5_cutoff",         VAR_UINT16 | MASTER_VALUE,  &masterConfig.gyro_soft_notch_cutoff_5, .config.minmax = { 1,  1000 } },
    { "gyro_notch6_hz",             VAR_UINT16 | MASTER_VALUE,  &masterConfig.gyro_soft_notch_hz_6, .config.minmax = { 0,  1000 } },
    { "gyro_notch6_cutoff",         VAR_UINT16 | MASTER_VALUE,  &masterConfig.gyro_soft_notch_cutoff_6, .config.minmax = { 1, 1000 } },
